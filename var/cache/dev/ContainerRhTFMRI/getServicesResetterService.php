...
}), ['http_exception_listener' => 'reset', 'form.choice_list_factory.cached' => 'reset', 'profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'fos_rest.view_handler.default' => 'reset', 'security.token_storage' => 'setToken', 'swiftmailer.email_sender.listener' => 'reset']);
